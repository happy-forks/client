...
type KeyFinder interface {
	...
	DeviceKIDs(ctx context.Context, tlfName string, teamID chat1.TLFID,
...
func (k *KeyFinderImpl) DeviceKIDs(ctx context.Context, tlfName string, tlfID chat1.TLFID,
	membersType chat1.ConversationMembersType, public bool) ([]keybase1.KID, error) {
	return k.createNameInfoSource(ctx, membersType).DeviceKIDs(ctx, tlfName, tlfID, membersType, public)
}
